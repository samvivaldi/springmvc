...
public class RequestBodyJsonController {
	 ...
	 *              MappingJackson2HttpMessageConverter (contenttype:
	 *              application/json) HTTP 요청시에 content-type이 application/json인지 꼭!
	 *              확인해야 한다. 그래야 JSON을 처리할 수 있는 HTTP 메시지 컨버터가 실행된다.
	 */
	@ResponseBody
